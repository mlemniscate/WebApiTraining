...
public interface IEmployeeService
{
    ...
    EmployeeDto CreateEmployeeForCompany(Guid companyId, EmployeeCreateDto employee, 
        bool trackChanges);
    ...
    (EmployeeUpdateDto employeeToPatch, Employee employeeEntity) GetEmployeeForPatch(
